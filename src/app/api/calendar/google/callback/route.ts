...
import { getGoogleTokens } from '@/lib/calendar/google-calendar'
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    // Get calendar list to store primary calendar info
    ...
    const primaryCalendar = await calendarListResponse.json()
